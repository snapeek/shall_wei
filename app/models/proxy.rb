class Proxy
  ...
  def self.get_from_dl
    ...
    url = "http://www.kuaidaili.com/api/getproxy/?orderid=952656895494348&num=30&area=%E4%B8%AD%E5%9B%BD&browser=1&protocol=1&method=2&an_ha=1&sp1=1&sp2=1&sort=0&format=text&sep=4"
